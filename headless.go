...
func main() {
	...
	vcs := app.New()
	configFilepath, bannedFilePath, distributionModeFlag, _, appLogger, _ := parseFlags(true, vcs.GetEventBus())
	...
	vcs.HeadlessStartup(appLogger, configFilepath, bannedFilePath, distributionMode)
